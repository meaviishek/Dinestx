  ...
  <header
    ...
    after:duration-500 after:rounded-t-full` }
            ...
            <div className="flex text-2xl items-center justify-end gap-3">
                <a className="animate-spin inline-flex items-center justify-center rounded-xl bg-gray-600 px-3 py-2 text-sm font-semibold text-white shadow-sm transition-all duration-150 hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 "
