...
function Footer() {
  ...
  return (
    <div className=' mt-8  overflow-hidden bg-gray-900'><footer className="text-gray-500  px-4 py-5  max-w-screen-xl mx-auto md:px-8">
    ...
    <div aria-hidden="true" className="absolute left-1/2 top-0 -z-10 -translate-x-1/2 blur-3xl xl:-top-6">
        <div
          ...
          className="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-[#ff8086] to-[#3e31e7] opacity-30"
        />
      </div>
    <style jsx>{`
        .svg-icon path,
